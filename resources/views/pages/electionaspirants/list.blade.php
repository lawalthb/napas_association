...
<?php
    ...
    $position_id_option_list_2 = $comp_model->position_id_option_list_2();
            ...
            <div class="col-md-2 comp-grid " >
                <form method="get" action="" class="form">
                    <div class="card mb-3 p-3 ">
                        <div class="">
                            <div class="fw-bold">Filter by Position Id</div>
                        </div>
                        <select   name="position_id" class="form-select custom " >
                        <option value="">Select a value ...</option>
                        <?php 
                            $options = $position_id_option_list_2 ?? [];
                    ...
                    <div id="electionaspirants-list-records">
                        <div id="page-main-content" class="table-responsive">
                            ...
                            <div class="filter-tags mb-2">
                                ...
                                <?php
                                    Html::filter_tag('position_id', 'Position Id', $position_id_option_list_2);
                                ?>
                                <?php
