                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td class="td-category_id">
                                                        <a size="sm" class="btn btn-sm btn " href="#">
                                                            <?php echo $data['contestcategories_name'] ?>
                                                        </a>
                                                    </td>
                                                    <td class="td-vote_link">
                                                        <a target="_blank" href="<?php echo $data['vote_link']; ?>" id="link-<?php echo $data['id']; ?>"><?php echo $data['vote_link']; ?></a>
                                                        <i class="material-icons copy-icon" title="Copy and share link to your friends" data-link-id="<?php echo $data['id']; ?>">content_copy</i>
...
<script>
    ...
    copyIcons.forEach(icon => {
        icon.addEventListener('click', () => {
            const linkId = icon.dataset.linkId;
            copyLink(linkId);
        });
    });
</script>
