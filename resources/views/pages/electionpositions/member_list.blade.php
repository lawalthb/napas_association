        ...
        <div class="row ">
            <div class="col comp-grid " >
                <div  class=" page-content" >
                    <div id="electionpositions-member_list-records">
                        <div id="page-main-content" class="table-responsive">
                            <?php Html::page_bread_crumb("/electionpositions/member_list", $field_name, $field_value); ?>
                            ...
                            <table class="table table-hover table-striped table-sm text-left">
                                <thead class="table-header ">
                                    <tr>
                                        ...
                                        <th class="td-name" > Positions</th>
                                        <th class="td-form_amt" > Form Amount</th>
                                        <th class="td-#Template#Buy Form" > Buy Form</th>
                                ...
                                <tbody class="page-data">
                                    ...
                                    <tr>
                                        ...
                                        <td class="td-#Template#Buy Form"><a href="/election_positions.form_amt"> Buy </a></td>
