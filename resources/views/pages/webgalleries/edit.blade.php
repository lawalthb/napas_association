                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-position-holder" class=" ">
                                            <input id="ctrl-position" data-field="position"  value="<?php  echo $data['position']; ?>" type="number" placeholder="Enter Position" min="1" step="1"  required="" name="position"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <input id="ctrl-updated_by" data-field="updated_by"  value="<?php  echo $data['updated_by']; ?>" type="hidden" placeholder="Enter Updated By" list="updated_by_list"  name="updated_by"  class="form-control " />
