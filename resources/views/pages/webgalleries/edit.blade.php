                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-academic_session-holder" class=" ">
                                            <input id="ctrl-academic_session" data-field="academic_session"  value="<?php  echo $data['academic_session']; ?>" type="text" placeholder="Enter Academic Session"  required="" name="academic_session"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
