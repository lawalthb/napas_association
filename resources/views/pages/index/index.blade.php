        ...
        <?php
            $pageTitle = "napas_association"; // set page title
        ?>
        @extends($layout)
                ...
                <div class="container-fluid">
                    <div class="row justify-content-center">
                            ...
                            <div>
                                ...
                                <form name="loginForm" action="{{ route('auth.login') }}" class="needs-validation form page-form" method="post">
                                    ...
                                    <div class="input-group form-group">
                                        <input placeholder="Email or Phone Number" name="username"  required="required" class="form-control" type="text"  />
                        ...
                        <div class=" card-7">                                   <div class="text-center">
                            Don't Have an Account? <a href="/#registration" class="btn btn-success">Register
