                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-permission-holder" class=" ">
                                            <select required=""  id="ctrl-permission" data-field="permission" name="permission"  placeholder="Select a value ..."    class="form-select" >
                                            ...
                                            <?php
                                                ...
                                                $selected = ( $value == $data['permission'] ? 'selected' : null );
                                            ?>
