...
<?php
    $pageTitle = "Add New Price Setting"; //set dynamic page title
?>
@extends($layout)
    ...
    <div  class="bg-light p-3 mb-3" >
        <div class="container">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">Add New Price Setting</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row ">
                <div class="col-md-9 comp-grid " >
                    <div  class="card card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form id="pricesettings-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="{{ route('pricesettings.store') }}" method="post">
                            @csrf
                            <div>
                                ...
                                <div class="form-group ">
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <label class="control-label" for="accademic_session_id">Accademic Session Id <span class="text-danger">*</span></label>
                                        </div>
                                        <div class="col-sm-8">
                                            <div id="ctrl-accademic_session_id-holder" class=" ">
                                                <select required=""  id="ctrl-accademic_session_id" data-field="accademic_session_id" name="accademic_session_id"  placeholder="Select a value ..."    class="form-select" >
                                                ...
                                                <?php 
                                                    ...
                                                    $selected = Html::get_field_selected('accademic_session_id', $value, "");
                                                ?>
