    ...
    <div  class="bg-light p-3 mb-3" >
        <div class="container-fluid">
            <div class="row justify-content-between align-items-center gap-3">
                <div class="col  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">Resource Items</div>
                    </div>
                </div>
                <div class="col-auto  " >
                    <?php if($can_add){ ?>
                    <a  class="btn btn-primary btn-block" href="<?php print_link("resourceitems/add_videos", true) ?>" >
    ...
    <div class="container-fluid">
        ...
        <div class="col-10 comp-grid " >
            <div  class=" page-content" >
                <div id="resourceitems-list_videos-records">
                    <div id="page-main-content" class="table-responsive">
                        <?php Html::page_bread_crumb("/resourceitems/list_videos", $field_name, $field_value); ?>
                            ...
                            <tbody class="page-data">
                                ...
                                <td class="td-btn">
                                    <div class="dropdown" >
                                        ...
                                        <?php } ?>
                                        <?php if($can_edit){ ?>
                                        <a class="dropdown-item "   href="<?php print_link("resourceitems/edit_video/$rec_id"); ?>" >
