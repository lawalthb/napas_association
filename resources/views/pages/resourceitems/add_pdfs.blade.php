            ...
            <div class="row ">
                <div class="col-md-9 comp-grid " >
                    <div  class="card card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form id="resourceitems-add_pdfs-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="{{ route('resourceitems.add_pdfs_store') }}" method="post">
                            @csrf
                            <div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-file_path-holder" class=" ">
                                                <div class="dropzone " input="#ctrl-file_path" fieldname="file_path" uploadurl="{{ url('fileuploader/upload/file_path') }}"    data-multiple="false" dropmsg="Choose files or drop files here"    btntext="Browse" extensions=".docx,.doc,.xls,.xlsx,.xml,.csv,.pdf,.xps" filesize="10" maximum="1">
