            ...
            <div class="row ">
                <div class="col-md-9 comp-grid " >
                    <div  class="card card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form novalidate  id="" role="form" enctype="multipart/form-data"  class="form page-form form-horizontal needs-validation" action="<?php print_link("resourceitems/edit_video/$rec_id"); ?>" method="post">
                        <!--[form-content-start]-->
                        @csrf
                        <div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-file_path-holder" class=" ">
                                            <div class="dropzone " input="#ctrl-file_path" fieldname="file_path" uploadurl="{{ url('fileuploader/upload/file_path') }}"    data-multiple="false" dropmsg="Choose files or drop files here"    btntext="Browse" extensions=".mp3,.mp4,.webm,.wav,.avi,.mpg,.mpeg" filesize="3" maximum="1">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div id="ctrl-category_id-holder" class=" ">
                                            <input id="ctrl-category_id" data-field="category_id"  value="<?php  echo $data['category_id']; ?>" type="number" placeholder="Enter Category" step="any"  required="" name="category_id"  class="form-control " />
                                        </div>
                                    </div>
                                </div>
                            </div>
