                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="avatar-lg me-4">
                                                            <a href="{{$contestant->vote_link}}" target="_blank">
                                                                @if($contestant && $contestant->image)
                                                                <img src="{{$contestant->user->image}}" class="img-fluid rounded" alt="" width="100px" height="100px">
                                                                @else
                                                                No Image
                                                                @endif
                                                    ...
                                                    <td>
                                                        <div>
                                                            <h5 class="font-size-18"><a href="{{$contestant->vote_link}}" target="_blank" class="text-dark">{{$contestant->contest_categories->name}}</a></h5>
                                                    ...
                                                    <td>
                                                        <ul class="list-unstyled ps-0 mb-0">
                                                            ...
                                                            <li><a href="{{$contestant->vote_link}}" target="_blank">{{$contestant->vote_link}}</p>
                                                            </li>
                                                        </ul>
                                                    </td>
                                                    ...
                                                    <td style="width: 220px;">
                                                        <h3 class="mb-0 font-size-20"><b>₦{{$contestant->contest_categories->price}}</b></h3>
                                                    </td>

                                                    <td><a href="{{$contestant->vote_link}}" target="_blank">
                                                            <button type="button" class="btn btn-primary waves-effect waves-light"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">
