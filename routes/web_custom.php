...
Route::get('/home', 'IndexController@index')->name('dashboard')->middleware(['redirect.to.home']);
...
Route::middleware(['auth', 'verified', 'rbac'])->group(function () {
  ...
  Route::any('appsettings/editfield/{rec_id}', 'AppSettingsController@editfield');
  ...
  Route::any('electionpositions/editfield/{rec_id}', 'ElectionPositionsController@editfield');
  ...
  Route::any('webcounters/editfield/{rec_id}', 'WebCountersController@editfield');
...
Route::get(
  'componentsdata/value_option_list',
  function (Request $request) {
...
Route::get(
  'componentsdata/contestvotes_category_id_option_list',
  function (Request $request) {
    $compModel = new App\Models\ComponentsData();
...
Route::get(
  'componentsdata/finalprojects_user_id_option_list',
  function (Request $request) {
    $compModel = new App\Models\ComponentsData();
...
Route::get(
  'componentsdata/finalprojects_user_id_value_exist',
  function (Request $request) {
    $compModel = new App\Models\ComponentsData();
...
Route::get(
  'componentsdata/permission_option_list',
  function (Request $request) {
    $compModel = new App\Models\ComponentsData();
...
Route::get(
  'componentsdata/users_level_id_option_list',
  function (Request $request) {
    $compModel = new App\Models\ComponentsData();
...
Route::get(
  'componentsdata/academic_session_id_option_list_2',
  function (Request $request) {
    $compModel = new App\Models\ComponentsData();
...
Route::get(
  'componentsdata/category_id_option_list_2',
  function (Request $request) {
    $compModel = new App\Models\ComponentsData();
...
Route::get(
  'componentsdata/position_id_option_list_2',
  function (Request $request) {
    $compModel = new App\Models\ComponentsData();
...
Route::get(
  'componentsdata/electionaspirants_academic_session_autofill',
  function (Request $request) {
    $compModel = new App\Models\ComponentsData();
...
Route::get(
  'componentsdata/category_id_option_list_3',
  function (Request $request) {
    $compModel = new App\Models\ComponentsData();
...
Route::get(
  'componentsdata/price_settings_id_option_list_2',
  function (Request $request) {
    $compModel = new App\Models\ComponentsData();
